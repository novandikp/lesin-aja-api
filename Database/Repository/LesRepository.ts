...
export default class LesRepository {
  ...
  get(index){
      return this.db.one(`SELECT tblles.*,tblwali.idkecamatan,idguru,statuslowongan, idortu, tblpaket.jumlah_pertemuan, biaya,siswa, tblpaket.jenjang,kelas, jeniskelamin,gaji 
      FROM tblles 
